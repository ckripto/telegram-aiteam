...
- `app.py`: main long-polling application, Telegram command handling, delegation flows, reminder processing, and visible agent message emission.
...
- `storage.py`: SQLite event/reminder persistence.
